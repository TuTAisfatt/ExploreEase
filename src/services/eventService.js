  ...
  const samples = [
    ...
    },
    {
    ...
    },
      {
        ...
        category:    'adventure',
        description: 'Join hundreds of runners for a scenic night run through the lit-up streets of District 1.',
        address:     'Nguyen Hue Walking Street, District 1',
        location:    { latitude: 10.7769, longitude: 106.7009 },
        imageUrl:    'https://res.cloudinary.com/dpmtwyqg6/image/upload/v1775556267/maxresdefault-1368777436_kbm0d9.jpg',
        price:       100000,
        startDate:   Timestamp.fromDate(new Date(now.getTime() + 4 * d)),
        endDate:     Timestamp.fromDate(new Date(now.getTime() + 4 * d + 3 * h)),
        approved:    true,
        attendees:   [],
        organizerId: 'admin',
      },
      {
        title:       'HCMC Art Exhibition',
        category:    'culture',
        description: 'A showcase of contemporary Vietnamese art featuring paintings, sculptures and digital art from local artists.',
        address:     'Ho Chi Minh City Museum of Fine Arts, District 1',
        location:    { latitude: 10.7700, longitude: 106.7020 },
        imageUrl:    'https://res.cloudinary.com/dpmtwyqg6/image/upload/v1775556268/287499355_5130487493653574_2659208267213764791_n-4142084418_mc4fct.jpg',
        price:       50000,
        startDate:   Timestamp.fromDate(new Date(now.getTime() + 6 * d)),
        endDate:     Timestamp.fromDate(new Date(now.getTime() + 6 * d + 5 * h)),
        approved:    true,
        attendees:   [],
        organizerId: 'admin',
      },
